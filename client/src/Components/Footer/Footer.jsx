    ...
    <>
      ...
      <div className={`flex justify-center ${styles.footer}`}>
        ...
        <div className={styles.col3}>
          ...
          <p className='text-white sans-font'><a href="https://github.com/MahendraPatibandla" className='text-white sans-font'>GitHub repository<LuExternalLink /></a></p>
          <p className='text-white sans-font'><a href="" className='text-white sans-font'>Twitter<LuExternalLink /></a></p>
          <p className='text-white sans-font'><a href="https://www.linkedin.com/in/mahendrapatibandla" className='text-white sans-font'>LinkedIn<LuExternalLink /></a></p>
